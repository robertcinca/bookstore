    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Page to browse books (Customer)</h1>\n"
                    + "		<a href=\"/bookstore/browse.do\" class=\"button\">Manager View</a>\n"
...
//                } //uncomment!!
                ...
                //book list (manager)
                out.println("<h1>Page to browse books (Manager)</h1> <a href=\"/bookstore/browse.do\" class=\"button\">Customer View</a>\n"
